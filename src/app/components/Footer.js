...
export default function Footer() {
  return (
    <div className='flex flex-col min-[640px]:flex-row min-[640px]:justify-between min-[640px]:px-[140px] gap-4 bg-[#252F3D] items-center p-4 h-[102px] min-[640px]:h-[88px]'>
      ...
      <div className='flex flex-row items-center h-8 gap-2 min-[640px]:mt-3'>
