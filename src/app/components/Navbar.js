...
export default function Navbar() {
  return (
    <div>
      <div className='flex px-5 py-[10px] justify-between mx-auto bg-[#252F3D] h-[42px] items-center'>
        <div className=''>
          <Image
            src={image1}
            width={7.5}
      ...
      <div className='flex justify-between w-80 h-[60px] mx-auto items-center'>
        <div>
          <Image
            src={image4}
            width={106.67}
